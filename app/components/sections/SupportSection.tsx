...
import { FiUser, FiMail, FiMessageSquare, FiSend, FiHelpCircle } from 'react-icons/fi';
...
const SupportSection = () => {
  ...
  return (
    <section className="py-5 md:py-5 bg-linear-to-br from-white to-gray-50">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <div className="mb-8">
              ...
              <p className="text-gray-600">
                Have questions about our products or your order? Our team is ready to assist you.
              </p>
            </div>

            {/* Premium Form */}
            <div className="bg-white rounded-2xl shadow-xl p-6 md:p-8 border border-black/5">
              <form onSubmit={handleSubmit} className="space-y-5">
                {/* Name Field */}
                <div className="group">
                  <label htmlFor="name" className="block text-sm font-medium text-navy mb-2">
                    <FiUser className="inline mr-2 text-gold group-focus-within:text-gold" />
                    Your Name
                  </label>
                  <input
                    type="text"
                    ...
                    className="w-full px-4 py-3 rounded-lg border border-black/10 focus:border-gold focus:outline-none focus:ring-2 focus:ring-gold/20 transition bg-gray-50 focus:bg-white"
                  />
                </div>
                ...
                <div className="group">
                  <label htmlFor="subject" className="block text-sm font-medium text-navy mb-2">
                    <FiHelpCircle className="inline mr-2 text-gold" />
                    Subject
                  </label>
                  <select
                    id="subject"
                ...
                <div className="group">
                  <label htmlFor="message" className="block text-sm font-medium text-navy mb-2">
                    <FiMessageSquare className="inline mr-2 text-gold" />
                    Your Message
                  </label>
                  <textarea
                    id="message"
                    ...
                    className="w-full px-4 py-3 rounded-lg border border-black/10 focus:border-gold focus:outline-none focus:ring-2 focus:ring-gold/20 transition bg-gray-50 focus:bg-white resize-none"
                  ></textarea>
                </div>
                ...
                <button
                  type="submit"
                  className="w-full bg-gold text-navy py-3.5 px-6 rounded-lg font-bold flex items-center justify-center gap-2 hover:bg-navy hover:text-gold transition-all duration-300 border-2 border-gold text-base shadow-lg shadow-gold/20 hover:shadow-xl"
                >
                  <FiSend size={18} />
                  Send Message
                </button>
          ...
          <div className="hidden lg:block">
            <div className="relative">
              {/* Your SVG */}
              <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 855.233 547.777" className="w-full h-auto">
                <g transform="translate(-514 -257.762)">
                  <g transform="translate(700.352 257.762)">
                    ...
                    <path d="M495.93,368.219s-46.167-3.617-64.27,9.052-40.12,51.908-40.12,51.908L384.61,444s10.83,1.157,9.93,2.975,14.486,10.86,21.72,8.142,25.346,11.73,27.155,13.577,42.54-2.717,42.54-2.717S470.584,401.708,495.93,368.219Z" transform="translate(-115.219 -139.328)" fill="#6c63ff"/>
                    ...
                    <path d="M131.735,526.6s8.142,1.808,24.437-1.808,22.629,3.617,31.68,7.243,32.589,5.435,41.641,1.808,18.1-10.86,37.144-2.717,31.68-8.152,50.683-6.373S349,517.51,349,517.51l-20.2-46.646-6.06-14.007L171.3,446.5h-.723Z" transform="translate(278.892 -141.102)" fill="#6c63ff"/>
                    <path d="M197.7,374.624s49.783-9.961,73.311,2.717,41.631,40.732,41.631,40.732,14.263,37.864,12.3,48.874-33.106,0-33.106,0-38.923-9.052-44.358,4.526-30.781,6.334-30.781,6.334-52.5-14.486-62.461,1.808Z" transform="translate(280.779 -139.398)" fill="#6c63ff"/>
                  ...
                  <g transform="translate(278.05 -85.367)">
                    ...
                    <path d="M284.445,544.488c1.113-2.582,2.428-6.522,5.474-5.088,1.505.653,4.2,2.635,5.295.329l8.57-17.939a2.791,2.791,0,0,1,3.787-1.263l15.235,7.971a21.97,21.97,0,0,1-.365,3.685l-37.1,13.114Z" transform="translate(181.218 -42.916)" fill="#6c63ff"/>
                  </g>
                  <g transform="translate(540.32 386.688) rotate(11)">
                    ...
                    <path d="M45.964,4.109H2.054A2.054,2.054,0,0,1,2.054,0h43.91a2.054,2.054,0,0,1,0,4.109Z" transform="translate(44.058 32.378)" fill="#6c63ff"/>
                    <path d="M54.438,4.109H2.054A2.054,2.054,0,0,1,2.054,0H54.438a2.054,2.054,0,1,1,0,4.109Z" transform="translate(44.058 39.311)" fill="#6c63ff"/>
                    ...
                    <circle cx="7.261" cy="7.261" r="7.261" transform="translate(20.566 30.638)" fill="#6c63ff"/>
                    ...
                    <path d="M14.521,7.262a7.261,7.261,0,0,1-7.26,7.263,1.559,1.559,0,0,1-.187-.007,7.26,7.26,0,1,1,7.446-7.256Z" transform="translate(21.313 61.706)" fill="#6c63ff"/>
                    <circle cx="7.261" cy="7.261" r="7.261" transform="translate(20.566 92.779)" fill="#6c63ff"/>
              ...
              {/* Floating Badge */}
              <div className="absolute bottom-10 left-10 bg-white rounded-lg shadow-xl p-3 animate-float">
                <p className="text-navy font-semibold text-sm">✨ 24/7 Support</p>
              </div>
              
              {/* Response Time Badge */}
<div className="absolute top-0 right-0 bg-gold/10 rounded-lg p-3 border border-gold/20">
  <p className="text-navy text-xs">⏱️ Avg. response</p>
  <p className="text-gold font-bold">2-4 hours</p>
</div>
            </div>
          </div>
        </div>
